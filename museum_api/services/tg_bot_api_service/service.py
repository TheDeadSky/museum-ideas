...
class TgBotAPIService:
    """
    Service for sending requests to the Telegram bot API
    """
    ...
    def __init__(
        ...
        Args:
            base_url: Base URL for the Telegram bot API (defaults to config setting)
        """
        self.base_url = (base_url or settings.TG_BOT_API_BASE_URL).rstrip('/')
